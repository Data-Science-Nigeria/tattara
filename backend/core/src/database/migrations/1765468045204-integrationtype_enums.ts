...
export class IntegrationtypeEnums1765468045204 implements MigrationInterface {
  name = 'IntegrationtypeEnums1765468045204';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."external_connections_type_enum" AS ENUM('dhis2', 'postgres', 'sql')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."field_mappings_target_type_enum" AS ENUM('dhis2', 'postgres', 'sql')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."workflow_configurations_type_enum" AS ENUM('dhis2', 'postgres', 'sql')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."workflow_configurations_type_enum_old" AS ENUM('dhis2', 'postgres')`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflow_configurations" ALTER COLUMN "type" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."field_mappings_target_type_enum_old" AS ENUM('dhis2', 'postgres')`,
    );
    await queryRunner.query(
      `ALTER TABLE "field_mappings" ALTER COLUMN "target_type" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."external_connections_type_enum_old" AS ENUM('dhis2', 'postgres')`,
    );
    await queryRunner.query(
