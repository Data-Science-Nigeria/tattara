...
export const VerificationContent = ({
  ...
  return (
    <div className="mb-4 text-center">
      <div className={`mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full ${isError ? 'bg-red-100' : 'bg-green-100'}`}>
        {isError ? (
      ...
      {isError ? (
        ...
        <p className="text-sm text-[#5C5D6C]">
          ...
          <span className="font-semibold text-[#008647]">{email}</span> has been verified
        </p>
      )}
