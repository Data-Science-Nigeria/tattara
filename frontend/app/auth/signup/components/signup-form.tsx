...
export function SignUpForm() {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex gap-4">
          <div className="flex-1">
            ...
            <input
              ...
              className="mt-1 w-full rounded border p-2 bg-[#F2F3FF] placeholder:text-sm placeholder:text-[#525F76] focus:border-[#03390F] focus:ring-[#03390F] focus:outline-none"
            />
            {errors.firstName && (
