...
import { ChevronDown, Download, Edit, UserX, Trash2, MoreHorizontal } from 'lucide-react';
...
export default function ProgramTable({ data = [] }: ProgramTableProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Table */}
      <div className="rounded-md border bg-white overflow-x-auto overflow-y-visible">
        <table className="w-full">
            <thead className="bg-[#F2F3FF]">
              <tr>
                <th className="px-6 py-4 text-left font-semibold text-gray-700">Name</th>
                <th className="px-6 py-4 text-left font-semibold text-gray-700">Assigned Program</th>
            ...
            <tbody>
              {currentData.map((item, index) => (
                <tr key={index} className="border-b" data-row={index}>
                  ...
                  <td className="px-6 py-4 text-gray-700">{item.program || 'N/A'}</td>
                  <td className="px-6 py-4 text-gray-700">{item.completedOn || 'N/A'}</td>
                  ...
                  <td className="px-6 py-4 text-gray-700 relative">
                    <div className="relative">
                      ...
                      {activeDropdown === index && (
                        ...
                        >
                          <div>
                            <button className="w-full px-3 py-2 text-left flex items-center gap-2 bg-green-600 text-white hover:bg-green-700 rounded-t-lg">
